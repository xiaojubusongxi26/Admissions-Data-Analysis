  ...
  <div class="operate-user">
    ...
    <div class="search-user">
      ...
      <div class="search-btn">
        ...
        <el-button type="primary" icon="el-icon-thumb">清除</el-button>
      </div>
    </div>
  </div>
  <!-- 用户信息展示列表 -->
  <div class="user-list">
    <el-descriptions v-for="(item, index) in userList" :key="index" class="margin-top" :title="'ID: ' + item.userId" :column="3" border>
      <template slot="extra">
        <el-button type="primary" size="small" @click="goUserInfo(1, item.userId)">详情</el-button>
        <el-button type="primary" size="small" @click="goUserInfo(2, item.userId)">修改</el-button>
        <el-button type="primary" size="small" v-if="item.userState === 1" @click="open(item)">注销</el-button>
        <el-button type="primary" size="small" v-else  @click="open(item)">启用</el-button>
        <el-button type="primary" size="small" @click="goUserInfo(3, item.userId)">重置密码</el-button>
      </template>
      ...
      <el-descriptions-item>
        ...
        <el-tag size="small" v-if="item.userState">启用</el-tag>
...
.user-list {
  ...
  ::v-deep .el-descriptions {
    ...
    transition: .2s all;
    border-radius: 6px;
    box-shadow: 0 4px 8px 0 rgb(189 189 189 / 20%), 0 3px 20px 0 rgb(203 203 203 / 19%);
    &:hover {
